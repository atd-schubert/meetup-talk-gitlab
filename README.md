# WhereGroup Reveal Presentation Template

## Abstract
This is a dummy presentation used as template for other presentations.
Please change this description when you create a new presentation...

## How to run

### Prerequirements

1. You should have an installed version of [node.js](https://nodejs.org/) (>4.x.x).
2. You should have installed [Grunt](http://gruntjs.com/) globally.

### Start presentation

Go into the project folder with a console and run:
```bash
npm install
grunt serve
```
...
*The following text is the original Readme content of the reveal-project*
